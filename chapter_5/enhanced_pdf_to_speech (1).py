...
# Intentar importar ttkthemes, pero es opcional
try:
...
def instalar_requisitos():
    ...
    os.system("pip install PyPDF2 pyttsx3 pygame gTTS")
    print("¿Desea instalar temas visuales mejorados? (s/n)")
    respuesta = input()
    if respuesta.lower() == 's':
        os.system("pip install ttkthemes")
        print("Temas visuales instalados.")
...
class PDFToSpeechApp:
    def __init__(self, root):
        ...
        style.configure("Exit.TButton", font=("Helvetica", 11, "bold"), foreground="red")
    ...
    def create_widgets(self):
        ...
        # Botón para salir
        exit_button = ttk.Button(main_frame, text="Salir", command=self.root.destroy, style="Exit.TButton")
...
if __name__ == "__main__":
    ...
    # Iniciar la aplicación con tema si está disponible
    if HAS_THEMES:
        try:
        ...
        root = tk.Tk()  # Usar Tk normal si no hay ttkthemes
